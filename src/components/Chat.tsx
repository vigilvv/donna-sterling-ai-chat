...
const Chat: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hello, I'm Donna Sterling, your AI Appraiser. How can I assist you with property valuation today?",
    },
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if ((!inputValue.trim() && selectedImages.length === 0) || isSubmitting) return;
